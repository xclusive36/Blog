      ...
      <IonCard>
        <IonCardContent>
          <p className="ion-padding">
            <strong>Welcome to LiteStep!</strong>
            <br />
          ...
          <p className="ion-padding">
            Don’t misuse our Services. Don’t try to access our Services using
            any method other than the interface and the instructions provided.
            You may use our Services only as permitted by law, including
            applicable export and re-export control laws and regulations. We may
            suspend or stop providing our Services to you if you do not comply
            with our terms and conditions or policies or if we are investigating
          ...
          <p className="ion-padding">
            ...
            not reuse content from our Services unless granted permission or are
            otherwise permitted by law. These terms do not grant you the right
            to use any branding or logos used in our Services. Don’t remove,
            obscure, or alter any legal notices displayed in or along with our
            Services.
          </p>

          <p className="ion-padding">
            Any content provided is the sole responsibility of the entity that
            makes it available. We may review content to determine whether it is
            illegal or violates our policies, we may remove or refuse to display
          ...
          <p className="ion-padding">
            Do not use such Services in a way that distracts you and prevents
            you from obeying traffic or safety laws.
          </p>

          <p className="ion-padding">
            <strong>Your User Account</strong>
            <br />
            You will need a User Account in order to use our Services. You may
            create your own account, or you may use either an Apple, Google, or
            Facebook Account to Login.
          </p>

          <p className="ion-padding">
            To protect your LiteStep Account, keep your password confidential.
            You are responsible for the activity that happens in your LiteStep
            Account.
          </p>
          ...
          <p className="ion-padding">
            ...
            Services, you agree that LiteStep can use such data in accordance
          ...
          <p className="ion-padding">
            ...
            through our Services, you give LiteStep (and those we work with) a
            ...
            in this license are for the limited purpose of operating, promoting,
            and improving our Services, and to develop new ones. This license
            continues even if you stop using our Services. Some Services may
          ...
          <p className="ion-padding">
            ...
            content in the privacy policy. If you submit feedback or suggestions
            about our Services, we may use your feedback or suggestions without
            obligation to you.
          </p>
          ...
          <p className="ion-padding">
            ...
            provided to you by LiteStep as part of the Services. This license is
            for the sole purpose of enabling you to use and enjoy the benefit of
            the Services as provided by LiteStep, in the manner permitted by
          ...
          <p className="ion-padding">
            ...
            to see you go. LiteStep may also stop providing Services to you, or
          ...
          <p className="ion-padding">
            ...
            NEITHER LITESTEP NOR ITS SUPPLIERS OR DISTRIBUTORS MAKE ANY SPECIFIC
          ...
          <p className="ion-padding">
            TO THE EXTENT PERMITTED BY LAW, THE TOTAL LIABILITY OF LITESTEP, AND
          ...
          <p className="ion-padding">
            IN ALL CASES, LITESTEP, AND ITS SUPPLIERS AND DISTRIBUTORS, WILL NOT
          ...
          <p className="ion-padding">
            ...
            accepts these terms. It will hold harmless and indemnify LiteStep
          ...
          <p className="ion-padding">
            ...
            <br />
            We may modify these terms or Services at any time. We’ll post notice
            of modifications to these Terms and Services on this page. We’ll
          ...
          <p className="ion-padding">
            These terms control the relationship between LiteStep and you. They
          ...
          <p className="ion-padding">
            The laws of Maryland, U.S.A., will apply to any disputes arising out
            of or relating to these terms or the Services. All claims arising
            out of or relating to these terms or the Services will be litigated
            exclusively in the federal or state courts of Maryland, USA, and you
            and LiteStep consent to personal jurisdiction in those courts.
            <br />
            Regards,
            <br />
