        ...
        <IonCard>
          <IonCardContent>
            ...
            <p className="ion-padding">
              ...
              <br />
              We merely store information on Google Cloud servers on your
              behalf. What ever data you create within the application its self,
              you have full control over. It’s your data to Add, Edit, or
              Delete. If you do not wish to store any information, simply delete
              it off of the application. You will need an active subscription to
              access any data within the application. We want you to understand
              that you are in control of your data.
            </p>
            ...
            <p className="ion-padding">
              ...
              contacts our servers — for example, when you install an app from
              the IOS App Store or when a service checks for automatic updates.
            </p>
            ...
            <p className="ion-padding">
              ...
              services are used. For example, we analyze data about your visits
              to our sites to do things like optimize product design. We use a
